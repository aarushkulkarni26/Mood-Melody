                    ...
                    >
                      ...
                      >
                        ...
                        <h1 className="title-text-big">
                          The best way
                          <br className=" d-lg-block d-none" /> to get songs{" "}
                          <b>U</b> Love!
                        </h1>
                        <br />
                      ...
                      <div className="text-center title-text">
                        ...
                        >
                          You can easily find new songs with this powerfull
                          tool!
                        </p>
                      </div>
                      ...
                      <div className="grid-padding text-center">
                        <div className="row">
                          <div className="col-lg-4 column">
                            ...
                            <h3 className="icon-title text-white">
                              Easy to Operate
                            </h3>
                          ...
                          <div className="col-lg-4 column">
                            ...
                            <p className="icon-caption">
                              ...
                              <br />
                              will guarantee your data will be safe
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    >
                      <div className="list-footer">
                        <div className="row gap-md-0 gap-3">
                          ...
                          <div className="col-lg-3 col-md-6">
                            <h2 className="footer-text-title text-white">
                              Product
                            </h2>
                            <nav className="list-unstyled">
                              <li className="list-space">
